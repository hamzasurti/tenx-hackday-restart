...
export class SubmissionPage extends React.Component { // eslint-disable-line react/prefer-stateless-function
  render() {
    return (
      <div>
        <Helmet
          ...
          meta={[
            { name: 'description', content: 'Description of SubmissionPage' },
          ]}
        />
